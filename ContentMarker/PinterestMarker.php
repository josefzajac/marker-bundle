...
/**
 * Pinterest, replaces [pinterest url="*"] within strings with a rendered twig file (gets passed the url & id).
 *
 * @author Jakub Cerny <jakub.cerny@sinnerschrader.com>
 */
class PinterestMarker extends AbstractNodeMarker implements ContentMarkerInterface
{
    const PATTERN = '/\[pinterest url="(.+)"\]/miU';
